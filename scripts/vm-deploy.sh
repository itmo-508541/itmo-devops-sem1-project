...
ssh runner@$1 -o StrictHostKeyChecking=no "curl -fsSL https://get.docker.com -o get-docker.sh ;
...
scp -P 22 -r ./build/deploy.yml runner@$1:/srv/deploy.yml

ssh runner@$1 -o StrictHostKeyChecking=no "cd /srv ;
