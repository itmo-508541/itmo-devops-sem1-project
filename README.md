...
* `scripts/vm-create.sh` создаёт виртуальную машину в Yandex.Cloud (по необходимости) или запускает выключенную, а `scripts/user-data.yaml` содержит метаданные конфигурации cloud-init
